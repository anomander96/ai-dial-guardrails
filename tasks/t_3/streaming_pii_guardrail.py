...
class PresidioStreamingPIIGuardrail:
    ...
    def __init__(self, buffer_size: int = 100, safety_margin: int = 20):
        ...
        provider = NlpEngineProvider(nlp_engine_configuration = configurations)
...
def main():
    ...
    print("🔒 Secure Colleague Directory Assistant (Streaming Guardrail)")
    ...
    while True:
        ...
        for chunk in llm_client.stream(messages):
            ...
            safe_output = guardrail.process_chunk(chunk_text)
            if safe_output:
